...
/**
 * This is the item provider adapter for a {@link organisationalChart.organisationalChart.Role} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Role_superior_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Role_superior_feature", "_UI_Role_type"),
				 OrganisationalChartPackage.Literals.ROLE__SUPERIOR,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OrganisationalChartPackage.Literals.ROLE__NAME,
				 true,
				 false,
				 false,
