...
public class MessageFormatParser extends
		organisationalChart.organisationalChart.diagram.parsers.AbstractParser {
	...
	public IParserEditStatus isValidEditString(IAdaptable adapter,
		...
		if (values == null) {
			return new ParserEditStatus(
					...
					NLS
							.bind(
									organisationalChart.organisationalChart.diagram.part.Messages.MessageFormatParser_InvalidInputError,
