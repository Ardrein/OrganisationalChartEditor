...
public class DiagramEditorActionBarAdvisor extends ActionBarAdvisor {
	...
	protected void fillMenuBar(IMenuManager menu) {

		{
			IMenuManager menuX = new MenuManager(
					organisationalChart.organisationalChart.diagram.part.Messages.ApplicationMenuName_File,
...

			{
				IMenuManager menuXX = new MenuManager(
						organisationalChart.organisationalChart.diagram.part.Messages.ApplicationMenuName_New,
						"new");
		...
		{
			IMenuManager menuX = new MenuManager(
					organisationalChart.organisationalChart.diagram.part.Messages.ApplicationMenuName_Edit,
		...
		{
			IMenuManager menuX = new MenuManager(
					organisationalChart.organisationalChart.diagram.part.Messages.ApplicationMenuName_Window,
		...
		{
			IMenuManager menuX = new MenuManager(
					organisationalChart.organisationalChart.diagram.part.Messages.ApplicationMenuName_Help,
		...
		if (editorDescriptor == null) {
			MessageDialog
					.openError(
							...
							organisationalChart.organisationalChart.diagram.part.Messages.DiagramEditorActionBarAdvisor_DefaultFileEditorTitle,
							NLS
									.bind(
											organisationalChart.organisationalChart.diagram.part.Messages.DiagramEditorActionBarAdvisor_DefaultFileEditorMessage,
			...
			try {
				...
				MessageDialog
						.openError(
								workbenchWindow.getShell(),
								organisationalChart.organisationalChart.diagram.part.Messages.DiagramEditorActionBarAdvisor_DefaultEditorOpenErrorTitle,
	...
	public static class NewDiagramAction extends WorkbenchWindowActionDelegate {
		...
		public void run(IAction action) {
			organisationalChart.organisationalChart.diagram.part.ModeloCreationWizard wizard = new organisationalChart.organisationalChart.diagram.part.ModeloCreationWizard();
	...
	public static class AboutAction extends WorkbenchWindowActionDelegate {
		...
		public void run(IAction action) {
			MessageDialog
					.openInformation(
							getWindow().getShell(),
							organisationalChart.organisationalChart.diagram.part.Messages.DiagramEditorActionBarAdvisor_AboutDialogTitle,
							organisationalChart.organisationalChart.diagram.part.Messages.DiagramEditorActionBarAdvisor_AboutDialogMessage);
		}
	}
