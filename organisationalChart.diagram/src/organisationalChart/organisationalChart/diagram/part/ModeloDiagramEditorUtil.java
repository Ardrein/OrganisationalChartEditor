...
public class ModeloDiagramEditorUtil {
	...
	public static boolean openDiagram(Resource diagram)
		...
		page
				.openEditor(
						...
						organisationalChart.organisationalChart.diagram.part.ModeloDiagramEditor.ID);
		return true;
	}
	...
	public static Resource openModel(Shell shell, String description,
		...
		try {
			...
			MessageDialog
					.openError(
							shell,
							organisationalChart.organisationalChart.diagram.part.Messages.ModeloDiagramEditorUtil_OpenModelResourceErrorDialogTitle,
							NLS
									.bind(
											organisationalChart.organisationalChart.diagram.part.Messages.ModeloDiagramEditorUtil_OpenModelResourceErrorDialogMessage,
											fileName));
		}
		return resource;
	}
	...
	public static void runWizard(Shell shell, Wizard wizard, String settingsKey) {
		IDialogSettings pluginDialogSettings = organisationalChart.organisationalChart.diagram.part.ModeloDiagramEditorPlugin
	...
	public static Resource createDiagram(URI diagramURI, URI modelURI,
		...
		progressMonitor
				.beginTask(
						organisationalChart.organisationalChart.diagram.part.Messages.ModeloDiagramEditorUtil_CreateDiagramProgressTask,
						3);
		...
		AbstractTransactionalCommand command = new AbstractTransactionalCommand(
				editingDomain,
				organisationalChart.organisationalChart.diagram.part.Messages.ModeloDiagramEditorUtil_CreateDiagramCommandLabel,
				Collections.EMPTY_LIST) {
			protected CommandResult doExecuteWithResult(
					IProgressMonitor monitor, IAdaptable info)
					throws ExecutionException {
				organisationalChart.organisationalChart.Organisation model = createInitialModel();
	 ...
	 * @generated
	 */
	private static organisationalChart.organisationalChart.Organisation createInitialModel() {
		return organisationalChart.organisationalChart.OrganisationalChartFactory.eINSTANCE
				.createOrganisation();
	}
	...
	private static void attachModelToResource(
			organisationalChart.organisationalChart.Organisation model,
			Resource resource) {
