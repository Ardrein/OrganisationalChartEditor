...
public class DiagramEditorContextMenuProvider extends
	 ...
	 * @generated
	 */
	private organisationalChart.organisationalChart.diagram.part.DeleteElementAction deleteAction;
	...
	public DiagramEditorContextMenuProvider(IWorkbenchPart part,
		...
		super(part, viewer);
		this.part = part;
		deleteAction = new organisationalChart.organisationalChart.diagram.part.DeleteElementAction(
				part);
		deleteAction.init();
	}
