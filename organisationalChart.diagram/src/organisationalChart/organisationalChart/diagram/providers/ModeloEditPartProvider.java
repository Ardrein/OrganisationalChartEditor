 ...
 * @generated
 */
public class ModeloEditPartProvider extends AbstractEditPartProvider {
	...
	public ModeloEditPartProvider() {
		setFactory(new organisationalChart.organisationalChart.diagram.edit.parts.ModeloEditPartFactory());
